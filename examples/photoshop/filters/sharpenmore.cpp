...
Func output_1;
 output_1(x_0,x_1)  =  cast<uint8_t>(clamp(  ( (((((((
 	(( 2  * cast<int32_t>( input_1(x_0+1,x_1+1) ))
 	+ ( 2  * cast<int32_t>( input_1(x_0+1,x_1+1) ))
 	+ ( 2  * cast<int32_t>( input_1(x_0+1,x_1+1) )) 
 	+ ( 2  * cast<int32_t>( input_1(x_0+1,x_1+1) )) 
 	...
 	+ cast<int32_t>( input_1(x_0+1,x_1+1) ) 
 	+ cast<int32_t>( input_1(x_0+1,x_1+1) )) 
 	- (cast<int32_t>( input_1(x_0+1,x_1) ) + cast<int32_t>( input_1(x_0+1,x_1+2) ))) 
 	 - cast<int32_t>( input_1(x_0,x_1+1) ))
 	  - cast<int32_t>( input_1(x_0+2,x_1+1) ))
 	   - (cast<int32_t>( input_1(x_0,x_1) ) + cast<int32_t>( input_1(x_0,x_1+2) )))
 	    - (cast<int32_t>( input_1(x_0+2,x_1) ) + cast<int32_t>( input_1(x_0+2,x_1+2) ))) 
