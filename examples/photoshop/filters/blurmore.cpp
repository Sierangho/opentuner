...
Func output_2;
 output_2(x_0,x_1)  =  cast<uint8_t>(  ( 
 	((
 		((( 7  + 
 		( 2  * (cast<uint32_t>( input_1(x_0+1,x_1) ) 
 		 ...
 		 -  ( (cast<uint64_t>( 613566757 ) * cast<uint64_t>(( 7  + ( 2  * (cast<uint32_t>( input_1(x_0+1,x_1) ) + cast<uint32_t>( input_1(x_0,x_1+1) ) + cast<uint32_t>( input_1(x_0+1,x_1+1) ) + cast<uint32_t>( input_1(x_0+2,x_1+1) ) + cast<uint32_t>( input_1(x_0+1,x_1+2) ))) + cast<uint32_t>( input_1(x_0,x_1) ) + cast<uint32_t>( input_1(x_0+2,x_1) ) + cast<uint32_t>( input_1(x_0,x_1+2) ) + cast<uint32_t>( input_1(x_0+2,x_1+2) )))) )
 		  >> ( 32)) >> cast<uint32_t>( 1 )) 
 	+  ( (cast<uint64_t>( 613566757 ) * cast<uint64_t>(( 7  + ( 2  * (cast<uint32_t>( input_1(x_0+1,x_1) ) + cast<uint32_t>( input_1(x_0,x_1+1) ) + cast<uint32_t>( input_1(x_0+1,x_1+1) ) + cast<uint32_t>( input_1(x_0+2,x_1+1) ) + cast<uint32_t>( input_1(x_0+1,x_1+2) ))) + cast<uint32_t>( input_1(x_0,x_1) ) + cast<uint32_t>( input_1(x_0+2,x_1) ) + cast<uint32_t>( input_1(x_0,x_1+2) ) + cast<uint32_t>( input_1(x_0+2,x_1+2) )))) )
